...
The static release is installable as a progressive web app. After one online launch, its interface and bundled starter scene can open offline; new-location terrain, buildings, canopy, search, and satellite imagery still require internet access.
